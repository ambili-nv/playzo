...
//         setTimeSlots(response.data.timeSlots); // Assuming response.data.timeSlots is an array of objects
//       } catch (error) {
...
//             <h2 className="text-2xl font-semibold mb-4 text-gray-700">Date: {new Date(slot.date).toLocaleDateString()}</h2>
