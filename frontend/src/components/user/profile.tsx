...
const ProfilePage: React.FC = () => {
  ...
  const [ownerIds, setOwnerIds] = useState<any>(null)
    ...
    const fetchBookings = async () => {
      try {
        ...
        if (response.data && response.data.bookings) {
          ...
          // // Extract and save unique owner IDs
          // const newOwnerIds = new Set<string>();
          // //@ts-ignore
          // sortedBookings.forEach((booking) => {
          //   newOwnerIds.add(booking.venueId.ownerId._id);
          // });
          // setOwnerIds(newOwnerIds);
                    ...
                    //@ts-ignore
                    sortedBookings.forEach((booking) => {
                      const ownerId = booking.venueId.ownerId._id;
                      if (!newOwnerIds.includes(ownerId)) {
