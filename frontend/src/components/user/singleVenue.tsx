...
// //         const response = await axios.get(`${USER_API}/single-venue/${venueId}`);
// //         console.log(response.data,"venue details");
// //         console.log(response.data.ratings,"ratingsgssssssss");
...
// //                     {venue.rating.map((rating, index) => (
// //                       <div key={index} className="border-t pt-2 mt-2">
// //                         <StarRating rating={rating.rating} />
// //                         <p className="text-base mt-1 text-slate-600">{rating.comment}</p>
// //                         <p className="text-sm text-gray-500">- {rating.user}</p>
// //                       </div>
// //                     ))}
// //                   </div>
// //                 ) : (
// //                   <p className="text-base mt-2 text-slate-600">No ratings available.</p>
// //                 )}
// //               </div>
// //             </div>
...
//                   <div className="space-y-4">
//                     {rating.map((rating) => (
//                       <div key={rating._id} className="border-t pt-2 mt-2">
//                         <StarRating rating={rating.rating} />
//                         <p className="text-base mt-1 text-slate-600">{rating.comment}</p>
//                         <p className="text-sm text-gray-500">- {rating.userId.name}</p>
//                       </div>
//                     ))}
//                   </div>
//                 ) : (
