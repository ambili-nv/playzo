          ...
          {isSuccess ? (
            <div className="mt-5 text-center text-green-500">
              <svg
                ...
                strokeWidth={2}
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7 12l2 2-4 4m-2-6h3v3M19 12l2 2-4 4m0-8h3v3" />
              </svg>
              <h2 className="text-2xl font-bold">Payment Successful!</h2>
              <p className="mt-2">Your payment was successful. Thank you for your purchase!</p>
              <Link
            ...
            <div className="mt-5 text-center text-red-500">
              <svg
                ...
                strokeWidth={2}
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2-4 4m-2-6h3v3M19 12l2 2-4 4m0-8h3v3" />
              </svg>
              <h2 className="text-2xl font-bold">Payment Failed</h2>
              <p className="mt-2">Unfortunately, your payment could not be processed.</p>
              <p className="mt-2">Please try again or <Link to="/contact-support" className="underline">contact support</Link>.</p>
            </div>
          )}
        </div>
      </div>
